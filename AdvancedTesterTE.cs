namespace AdvancedTester
{
    ...
    public class AdvancedTesterTE
    {
        ...
        public delegate void TimedEventFireDelegate(AdvancedTesterTE evt);

        public event TimedEventFireDelegate OnFire;

        public AdvancedTesterTE(double interval)
        {
        ...
        public AdvancedTesterTE(double interval, Dictionary<string, object> args)
            : this(interval)
        {
            this.Args = args;
        }
